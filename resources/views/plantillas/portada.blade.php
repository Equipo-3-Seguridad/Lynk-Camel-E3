    ...
    <footer class="row row-cols-1 row-cols-sm-2 row-cols-md-5 py-5 my-5 border-top">
        ...
        <div class="col mb-3">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item mb-2"><a href="/register" class="nav-link p-0 text-muted"><i class="fas fa-pencil"></i> Registro</a></li>
            </ul>
        </div>
        ...
        <div class="col mb-3">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item mb-2"><i class="fa-solid fa-envelope" style="color: #5b5b5b;"></i> 20191272@uthh.edu.mx</li>
